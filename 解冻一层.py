...
dataset = TweetDataset(r"D:\360MoveData\Users\c\Desktop\LLM期末\archive\tweet_sentiment.csv", tokenizer)
...
plt.legend()
plt.tight_layout()
plt.savefig("loss_curve_epoch_thelastone.png", dpi=300)
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("accuracy_curve_epoch_thelastone.png", dpi=300)
plt.close()

print("已保存图像: loss_curve_epoch_thelastone.png, accuracy_curve_epoch_thelastone.png")
...
# 保存模型
torch.save(model.state_dict(), "gpt2_sentiment_thelastone.pth")
print("模型已保存：gpt2_sentiment_thelastone.pth")